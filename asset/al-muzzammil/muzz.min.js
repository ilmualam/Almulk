...
(function () {
  ...
  container.innerHTML = [
    ...
    '      <h3 class="ilm-mt-title">🎧 Bacaan Interaktif Surah Al-Muzzammil</h3>',
    '      <small class="ilm-mt-sub">Audio setiap ayat + rumi + terjemahan Melayu</small>',
    "    </div>",
    '    <div class="ilm-mt-controls">',
    '      <button type="button" class="ilm-mt-btn" data-role="play-all">▶ Play All</button>',
    '      <button type="button" class="ilm-mt-btn ilm-mt-btn-ghost" data-role="pause-all" disabled>⏸ Henti</button>',
  ...
  injectCss(
    ".ilm-mt-wrapper{margin:24px 0;border:1px solid #e0e0e0;border-radius:12px;overflow:hidden;background:#ffffff}" +
      ...
      ".ilm-mt-ayah-ar{font-size:1.8rem;line-height:1.7;text-align:right;font-family:'Amiri', 'Traditional Arabic', serif;color:#0c3808;padding-top:15px;margin-bottom:10px;}" +
