/**
 * ╔═══════════════════════════════════════════════════════════════════════════╗
 * ║  ILM AL-FATIHAH PREMIUM READER v3.0                                       ║
 * ║  The Most Advanced Surah Al-Fatihah Interactive Tool                      ║
 * ║                                                                           ║
 * ║  © 2025 IlmuAlam.com - All Rights Reserved                                ║
 * ║  License: Proprietary - For use on ilmualam.com only                      ║
 * ║  GitHub CDN Hosting Permitted                                             ║
 * ║                                                                           ║
 * ║  UNIQUE FEATURES (Competitor Differentiation):                            ║
 * ║  ✓ Word-by-word Arabic breakdown with hover translation                   ║
 * ║  ✓ Tajwid color-coded highlighting                                        ║
 * ║  ✓ Multiple qari audio selection (8 qaris)                                ║
 * ║  ✓ Auto-scroll during playback                                            ║
 * ║  ✓ Repeat mode for memorization (hafazan)                                 ║
 * ║  ✓ Playback speed control (0.5x - 1.5x)                                   ║
 * ║  ✓ Progress tracking with localStorage                                    ║
 * ║  ✓ Print-friendly mode                                                    ║
 * ║  ✓ Share individual ayat                                                  ║
 * ║  ✓ Dark/Light theme                                                       ║
 * ║  ✓ Keyboard shortcuts                                                     ║
 * ║  ✓ Mobile-optimized touch gestures                                        ║
 * ║                                                                           ║
 * ║  API: Al-Quran Cloud (alquran.cloud)                                      ║
...
(function() {
    ...
    const CONFIG = {
        ...
        domain: 'ilmualam.com',
        qariList: [
            { id: 'ar.alafasy', name: 'Mishary Rashid Alafasy', flag: '🇰🇼' },
            { id: 'ar.abdulbasitmurattal', name: 'Abdul Basit (Murattal)', flag: '🇪🇬' },
            { id: 'ar.abdullahbasfar', name: 'Abdullah Basfar', flag: '🇸🇦' },
            { id: 'ar.hudhaify', name: 'Ali Al-Hudhaify', flag: '🇸🇦' },
            { id: 'ar.minshawi', name: 'Mohamed Siddiq El-Minshawi', flag: '🇪🇬' },
            { id: 'ar.muhammadayyoub', name: 'Muhammad Ayyub', flag: '🇸🇦' },
            { id: 'ar.muhammadjibreel', name: 'Muhammad Jibreel', flag: '🇪🇬' },
            { id: 'ar.saaboramah', name: 'Saad Al-Ghamdi', flag: '🇸🇦' }
        ]
    };
    ...
    const FATIHAH_DATA = [
        {
            ...
            wordByWord: [
                { ar: 'بِسْمِ', rumi: 'bismi', ms: 'Dengan nama' },
                { ar: 'اللَّهِ', rumi: 'Allāhi', ms: 'Allah' },
                { ar: 'الرَّحْمَٰنِ', rumi: 'ar-Raḥmāni', ms: 'Yang Maha Pengasih' },
                { ar: 'الرَّحِيمِ', rumi: 'ar-Raḥīm', ms: 'lagi Maha Penyayang' }
            ],
        ...
        },
        {
            ...
            rumi: "Al-ḥamdu lillāhi rabbil-'ālamīn",
            translation: "Segala puji bagi Allah, Tuhan sekalian alam.",
            wordByWord: [
                { ar: 'الْحَمْدُ', rumi: 'al-ḥamdu', ms: 'Segala puji' },
                { ar: 'لِلَّهِ', rumi: 'lillāhi', ms: 'bagi Allah' },
                { ar: 'رَبِّ', rumi: 'Rabbi', ms: 'Tuhan' },
                { ar: 'الْعَالَمِينَ', rumi: "al-'ālamīn", ms: 'sekalian alam' }
            ],
        ...
        },
        {
            ...
            rumi: "Māliki yawmid-dīn",
            translation: "Yang Menguasai hari pembalasan.",
            wordByWord: [
                { ar: 'مَالِكِ', rumi: 'Māliki', ms: 'Yang Menguasai' },
                { ar: 'يَوْمِ', rumi: 'yawmi', ms: 'hari' },
                { ar: 'الدِّينِ', rumi: 'ad-dīn', ms: 'pembalasan' }
            ],
        ...
        },
        {
            ...
            wordByWord: [
                { ar: 'إِيَّاكَ', rumi: 'Iyyāka', ms: 'Hanya Engkau' },
                { ar: 'نَعْبُدُ', rumi: "na'budu", ms: 'kami sembah' },
                { ar: 'وَ', rumi: 'wa', ms: 'dan' },
                { ar: 'إِيَّاكَ', rumi: 'iyyāka', ms: 'hanya kepada Engkau' },
                { ar: 'نَسْتَعِينُ', rumi: "nasta'īn", ms: 'kami mohon pertolongan' }
            ],
            tajwid: 'Mad jaiz munfasil pada "iyyāka"',
        ...
        },
        {
            ...
            rumi: "Ihdinaṣ-ṣirāṭal-mustaqīm",
            translation: "Tunjukilah kami jalan yang lurus.",
            wordByWord: [
                { ar: 'اهْدِنَا', rumi: 'Ihdinā', ms: 'Tunjukilah kami' },
                { ar: 'الصِّرَاطَ', rumi: 'aṣ-ṣirāṭa', ms: 'jalan' },
                { ar: 'الْمُسْتَقِيمَ', rumi: 'al-mustaqīm', ms: 'yang lurus' }
            ],
            tajwid: 'Ikhfa hakiki pada nun sakinah sebelum ص',
        ...
        },
        {
            ...
            rumi: "Ṣirāṭal-lazīna an'amta 'alaihim ghairil-maghḍūbi 'alaihim wa laḍ-ḍāllīn",
            ...
            wordByWord: [
                { ar: 'صِرَاطَ', rumi: 'Ṣirāṭa', ms: 'Jalan' },
                { ar: 'الَّذِينَ', rumi: 'allazīna', ms: 'orang-orang yang' },
                { ar: 'أَنْعَمْتَ', rumi: "an'amta", ms: 'Engkau kurniakan nikmat' },
                { ar: 'عَلَيْهِمْ', rumi: "'alaihim", ms: 'kepada mereka' },
                { ar: 'غَيْرِ', rumi: 'ghairi', ms: 'bukan' },
                { ar: 'الْمَغْضُوبِ', rumi: 'al-maghḍūbi', ms: 'yang dimurkai' },
                { ar: 'عَلَيْهِمْ', rumi: "'alaihim", ms: 'ke atas mereka' },
                { ar: 'وَلَا', rumi: 'wa lā', ms: 'dan bukan' },
                { ar: 'الضَّالِّينَ', rumi: 'aḍ-ḍāllīn', ms: 'yang sesat' }
            ],
            tajwid: 'Mad lazim kalimi mutsaqqal pada "الضَّالِّينَ" (6 harakat)',
...
.ilm-fh-header h2{margin:0;font-size:1.4rem;font-weight:600;text-align:center!important;color:#fff;}
...
<div class="ilm-fh-wrap ${state.darkMode ? 'dark' : ''}" id="ilm-fh-main">
    <div class="ilm-fh-header">
        ...
        <h2 style="text-align:center;">Surah ${CONFIG.surahName}</h2>
        <div class="subtitle">Ummul Kitab • As-Sab'ul Mathani • ${CONFIG.surahMeaning}</div>
        <div class="meta-badges">
            <span class="badge">📖 Surah ke-1</span>
            <span class="badge">✨ 7 Ayat</span>
            <span class="badge">🕌 Makkiyyah</span>
            <span class="badge">📿 Dibaca ${state.readCount}x</span>
        </div>
    </div>
    ...
    <div class="ilm-fh-controls">
        ...
        <button class="ilm-fh-btn" id="ilm-fh-dark">${state.darkMode ? '☀️ Light' : '🌙 Dark'}</button>
    </div>

    <div class="ilm-fh-options">
        <span class="ilm-fh-chip ${state.showRumi ? 'active' : ''}" id="ilm-fh-rumi-toggle">📝 Rumi</span>
        <span class="ilm-fh-chip ${state.showTranslation ? 'active' : ''}" id="ilm-fh-trans-toggle">🇲🇾 Terjemahan</span>
        <span class="ilm-fh-chip ${state.showWordByWord ? 'active' : ''}" id="ilm-fh-wbw-toggle">📚 Perkataan</span>
        <span class="ilm-fh-chip ${state.showTajwid ? 'active' : ''}" id="ilm-fh-tajwid-toggle">🎯 Tajwid</span>
        <span class="ilm-fh-chip ${state.showTafsir ? 'active' : ''}" id="ilm-fh-tafsir-toggle">📖 Tafsir</span>
    </div>
    ...
    <div class="ilm-fh-nav">
        <button class="ilm-fh-btn" id="ilm-fh-prev">← Sebelum</button>
        <span class="ilm-fh-position" id="ilm-fh-position">1 / 7</span>
        <button class="ilm-fh-btn" id="ilm-fh-next">Seterus →</button>
    </div>

    <div class="ilm-fh-footer">
        Tool Bacaan Surah Al-Fatihah © <a href="https://ilmualam.com" target="_blank" style="color:#249749">IlmuAlam.com</a> 2025 | Versi 3.0
    </div>
</div>
<div class="ilm-fh-toast" id="ilm-fh-toast"></div>`;
            ...
            <div class="ilm-fh-ayat ${state.currentAyat === verse.number ? 'playing' : ''}" 
                ...
                <div class="ilm-fh-ayat-header">
                    ...
                    <div class="ilm-fh-ayat-actions">
                        <button class="ilm-fh-ayat-btn play-single" data-ayat="${verse.number}" title="Play ayat ini">▶</button>
                        <button class="ilm-fh-ayat-btn copy-ayat" data-ayat="${verse.number}" title="Copy">📋</button>
                        <button class="ilm-fh-ayat-btn share-ayat" data-ayat="${verse.number}" title="Share">📤</button>
                    </div>
                </div>
                ...
                ${state.showTajwid ? `<div class="ilm-fh-tajwid"><strong>🎯 Tajwid:</strong> ${verse.tajwid}</div>` : ''}
                
                ${state.showTafsir ? `<div class="ilm-fh-tafsir"><strong>📖 Tafsir:</strong> ${verse.tafsir}</div>` : ''}
            </div>
        `).join('');
    ...
    function playSingleAyat(ayatNum) {
        ...
        state.audio.play().then(() => {
            ...
            showToast('❌ Tidak dapat memainkan audio');
        });

        state.audio.onended = () => {
            if (state.repeatMode && state.currentRepeat < state.repeatCount - 1) {
                state.currentRepeat++;
                showToast(`🔁 Ulangan ${state.currentRepeat + 1}/${state.repeatCount}`);
    ...
    function playSequence() {
        if (state.currentAyat > CONFIG.totalAyat) {
            if (state.repeatMode && state.currentRepeat < state.repeatCount - 1) {
                ...
                state.readCount++;
                saveState();
                showToast('✅ Selesai membaca Al-Fatihah');
                updateUI();
                updateHeader();
            }
            return;
    ...
    function copyAyat(ayatNum) {
        ...
        navigator.clipboard.writeText(text).then(() => {
            showToast('✅ Ayat disalin ke papan klip');
        }).catch(() => {
    ...
    function updateHeader() {
        ...
        if (main) {
            ...
            if (badge) {
                badge.textContent = `📿 Dibaca ${state.readCount}x`;
            }
        }
    }
    ...
    function initEvents() {
        ...
        document.getElementById('ilm-fh-repeat')?.addEventListener('click', () => {
            ...
            saveState();
            showToast(state.repeatMode ? `🔁 Ulang ${state.repeatCount}x diaktifkan` : '🔁 Ulang dinyahaktifkan');
        ...
        document.getElementById('ilm-fh-dark')?.addEventListener('click', () => {
            ...
            document.getElementById('ilm-fh-dark').textContent = state.darkMode ? '☀️ Cerah' : '🌙 Gelap';
            saveState();
        });
    ...
    function init() {
        ...
        console.log('%c🕌 IlmuAlam Al-Fatihah Reader v3.0 Ready', 'color:#249749;font-weight:bold;font-size:14px');
    }
